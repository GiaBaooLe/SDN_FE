...
const Navigation = () => {
  ...
  return (
    <div
      ...
      } xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white font-bold bg-pink-600 w-[4%] hover:w-[15%] h-[100vh]  fixed `}
      ...
      <div className="relative">
        ...
        {dropdownOpen && userInfo && (
          ...
          >
            ...
            <li>
              <Link to="/profile" className="block px-4 py-2 hover:bg-pink-500">
                Profile
              </Link>
            </li>
            <li>
